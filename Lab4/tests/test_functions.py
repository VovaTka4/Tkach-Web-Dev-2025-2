...
@pytest.mark.parametrize("input_password, expected_output", [
    ("1", "Пароль должен содеражть как минимум 8 символов!"),
    ("h3aK9vBzM1qXeLp7CgQ0Tw2AnRUYfsd5XtjZcPmvoG8lyNbHWEDrV6pFikO4JMXau0YgR9Kt7BLiwhQYFeAVPnxscbZqdrT5omv2XUpG1lsj34WCE96kNDyMt7", "Пароль должен содержать не более 128 символов!"),
    ...
    ("Abracadabra§42", r"Используются запрещенные символы! Вводите только латинские или кириллические буквы, цифры 0-9, а также любые из спец. символов: ~ ! ? @ # $ % ^ & * _ - + ( ) [ ] { } > < / \ | \" ' . , : ;"),
    ("Abracadabra15", None)
])
